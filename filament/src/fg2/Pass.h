...
class PassExecutor {
    ...
    virtual void execute(Resource const& resources, backend::DriverApi& driver) noexcept = 0;
public:
    PassExecutor();
...
class Pass : private PassExecutor {
    ...
    void execute(Resource const& resources, backend::DriverApi& driver) noexcept final {
